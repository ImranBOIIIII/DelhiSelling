...
export default function ProductListingPage({
  ...
  const filteredProducts = useMemo(() => {
    let filtered = products.filter(p => {
      ...
      return matchesPrice && matchesBrand && matchesCondition && matchesMaterial;
    });
    ...
    return filtered;
  }, [products, priceRange, selectedBrands, selectedConditions, selectedStorage, sortBy]);
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="text-gray-600 mt-2">Explore our complete collection of premium bags</p>
        </div>
      </div>
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    ...
                    <div className="space-y-2">
                      {brands.map((brand, index) => (
                        <label key={`brand-${index}`} className="flex items-center space-x-2 cursor-pointer">
                          <input
                            type="checkbox"
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    ...
                    <div className="space-y-2">
                      {conditions.map((condition, index) => (
                        <label key={`condition-${index}`} className="flex items-center space-x-2 cursor-pointer">
                          <input
                            type="checkbox"
                  ...
                  <div className="border-t border-gray-200 pt-6">
                    ...
                    <div className="space-y-2">
                      {materialOptions.map((material, index) => (
                        <label key={`material-${index}`} className="flex items-center space-x-2 cursor-pointer">
                          <input
                            type="checkbox"
            ...
            {filteredProducts.length === 0 ? (
              ...
              <div className={`grid ${viewMode === 'grid' ? 'grid-cols-2 sm:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'} gap-4 sm:gap-6`}>
                {filteredProducts.map(product => {
                  ...
                  console.log('ProductListingPage product:', product);
                  return (
                    <ProductCard
                      key={product.id}
                      product={product}
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-xl max-h-[85vh] overflow-hidden">
            ...
            <div className="overflow-y-auto p-4 space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-2">
                  {brands.map((brand, index) => (
                    <label key={`mobile-brand-${index}`} className="flex items-center space-x-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={selectedBrands.includes(brand)}
                        onChange={() => toggleBrand(brand)}
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-2">
                  {conditions.map((condition, index) => (
                    <label key={`mobile-condition-${index}`} className="flex items-center space-x-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={selectedConditions.includes(condition)}
                        onChange={() => toggleCondition(condition)}
              ...
              <div className="border-t border-gray-200 pt-6 pb-6">
                ...
                <div className="space-y-2">
                  {materialOptions.map((material, index) => (
                    <label key={`mobile-material-${index}`} className="flex items-center space-x-2 cursor-pointer">
                      <input
                        type="checkbox"
                        checked={selectedStorage.includes(material)}
                        onChange={() => toggleStorage(material)}
